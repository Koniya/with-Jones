...
#void function is also a truthless function because it does not return anything that can be used in another part of the program
...
#a truthful function because it returns value
